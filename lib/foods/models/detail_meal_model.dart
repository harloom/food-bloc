...
class DetailMeal {
  ...
  List<String> getIngredients() {
    List<String> data = [];
    data.add('$strIngredient1');
    data.add('$strIngredient2');
    data.add('$strIngredient3');
    data.add('$strIngredient4');
    data.add('$strIngredient5');
    data.add('$strIngredient6');
    data.add('$strIngredient7');
    data.add('$strIngredient8');
    data.add('$strIngredient9');
    data.add('$strIngredient10');

    data.add('$strIngredient11');
    data.add('$strIngredient12');
    data.add('$strIngredient13');
    data.add('$strIngredient14');
    data.add('$strIngredient15');
    data.add('$strIngredient16');
    data.add('$strIngredient17');
    data.add('$strIngredient18');
    data.add('$strIngredient19');
    data.add('$strIngredient20');
    return data;
  }

  List<String> getMeasures() {
    List<String> data = [];
    data.add('$strMeasure1');
    data.add('$strMeasure2');
    data.add('$strMeasure3');
    data.add('$strMeasure4');
    data.add('$strMeasure5');
    data.add('$strMeasure6');
    data.add('$strMeasure7');
    data.add('$strMeasure8');
    data.add('$strMeasure9');
    data.add('$strMeasure10');

    data.add('$strMeasure11');
    data.add('$strMeasure12');
    data.add('$strMeasure13');
    data.add('$strMeasure14');
    data.add('$strMeasure15');
    data.add('$strMeasure16');
    data.add('$strMeasure17');
    data.add('$strMeasure18');
    data.add('$strMeasure19');
    data.add('$strMeasure20');
    return data;
  }
